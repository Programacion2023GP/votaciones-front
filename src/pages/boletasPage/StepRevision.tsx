...
const StepRevision: React.FC<StepRevisionProps> = ({
  voterCasilla,
  voterNVotos,
  seleccion,
  loading,
    ...
    <div className="review-header">
      ...
      <div>
        ...
        <div className="review-sub">
          Revisa cuidadosamente tus elecciones. Una vez enviada, no podrá modificarse.
        </div>
      </div>
    </div>
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              <div className="review-vote-name">
                {p.folio ? `${p.folio} · ` : ""}{p.project_name}
              </div>
              <div style={{ fontSize: ".75rem", color: "var(--gris)", marginTop: 2 }}>
                {p.project_place}
              </div>
            </div>
            <span
              className="review-vote-cat"
